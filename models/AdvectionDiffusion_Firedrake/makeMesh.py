...
def makeMesh(
    ...
    if meshShape == "square":
        ...
        bottom_wall_1 = gmsh.model.geo.add_physical_group(
            1, [line1], name="bottom_wall"
        )
        ...
        domain_5 = gmsh.model.geo.add_physical_group(
            dim=2, tags=[planeSurface1], name="domain"
        )
    ...
    if meshShape == "houses":
        ...
        planeSurface1 = gmsh.model.geo.add_plane_surface(
            wireTags=[curveLoop1, curveLoop2, curveLoop3]
        )

        # Create physical surfaces and curves
        bottom_wall_1 = gmsh.model.geo.add_physical_group(
            dim=1, tags=[line1], name="bottom_wall"
        )
        right_wall_2 = gmsh.model.geo.add_physical_group(1, [line2], name="right_wall")
        top_wall_3 = gmsh.model.geo.add_physical_group(1, [line3], name="top_wall")
        left_wall_4 = gmsh.model.geo.add_physical_group(1, [line4], name="left_wall")
        houses_5 = gmsh.model.geo.add_physical_group(
            1,
