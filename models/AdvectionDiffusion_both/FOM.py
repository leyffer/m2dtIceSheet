...
# TODO: make separate subclasses for the FEniCS and the FireDrake case.
# It should be a user decision which FE solver they want to use. Letting them make that decision by creating an
# environment that does specifically not include the other solver seems restrictive at best. It also means that when
# we share the code we need to supply two separate environments
