"""!
Optimization method for the OED objective
"""
...
class Optimization:
    ...
    def __init__(self, utility: OEDUtility) -> None:
        ...
        @param utility: OEDUtility object, includes the information about the
            utility function, its gradient, etc.
        """
        ...
        # not sure if the Optimization class really needs to know all these
        # objects or just the utility I'm including them for now for
        # consistency. Sven and Thomas can take them out if they are not needed
